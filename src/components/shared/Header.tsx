        ...
        <div className="max-w-[1280px] mx-auto px-3 md:px-10 lg:px-16">
          <div
            className={`
              ...
              ${
                scrolled
                  ? "border-white/20 bg-white/70 backdrop-blur-3xl backdrop-saturate-150 shadow-[0_12px_40px_rgba(0,0,0,0.08)]"
          ...
          >
            <div className="flex items-center justify-between h-16 md:h-20 px-6">
              ...
              <nav className="hidden md:flex items-center gap-8">
                {NAV_LINKS.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`nav-link text-sm transition-[color] duration-300 ${
                ...
                <Button
                  ...
                  variant="primary"
                  className="text-[0.72rem] rounded-[7px] px-5 py-2.5 ml-3 transition-transform duration-300 hover:scale-[1.03] active:scale-[0.98]"
                  icon={
              ...
              >
                <span
                  className={`block w-6 h-px bg-[#1A1A1A] transition-transform duration-300 ease-out ${
                    mobileMenuOpen ? "translate-y-[6px] rotate-45" : ""
                  }`}
                />
                <span
                  className={`block w-6 h-px bg-[#1A1A1A] transition-opacity duration-200 ease-out ${
