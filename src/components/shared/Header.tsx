    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
         // Update the scrolled background:
scrolled
  ? "bg-[#F5F5F7]/95 backdrop-blur-sm border-b border-[#D0D0D5]"
  : "bg-transparent"
        }`}
      >
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden md:flex items-center gap-8" aria-label="Main navigation">
              ...
              <Button
                ...
                variant="primary"
                className="text-[0.7rem] px-5 py-2.5 ml-2"
                icon={
                  <svg
                    width="13"
                    height="13"
            ...
            {/* Mobile Menu Toggle */}
            <button
              className="md:hidden flex flex-col gap-[5px] p-2 -mr-2 relative z-50"
